...
const Info: FC = () => {
  ...
  const { openModal }: { openModal?: string | undefined } = router.query;

  const [openAlertDialog, setOpenAlertDialog] = useState<boolean>(false);
  const [openTrackActivityDialog, setOpenTrackActivityDialog] =
    useState<boolean>(false);

  useEffect(() => {
    openModal !== undefined && setOpenTrackActivityDialog(true);
  }, [openModal]);

  const handleAgree = (): void => {
    void router.push("/optimization");
  };
  ...
  const handleTrackActivityAgree = (): void => {
    void router.push("/login");
  };

  const handleTrackActivityDisagree = (): void => {
    void router.push("/info");
  };
    ...
    <Layout title="Info">
      <div className={styles.wrapper}>
        <div className={styles.iconButtonsWrap}>
          ...
          <div className={styles.nextIcon} onClick={handleClosePage}>
      ...
      <AlertDialog
        ...
        handleClose={() => {
          setOpenTrackActivityDialog(false);
        }}
